...
function LoginPage() {
  ...
  return (
    <main className="page-wrap px-4 py-10">
      <div className="mx-auto w-full max-w-md rounded-2xl border border-[var(--line)] bg-[var(--chip-bg)] p-6 shadow-[0_8px_24px_rgba(30,90,72,0.06)]">
        <h1 className="text-lg font-semibold leading-none tracking-tight text-[var(--sea-ink)]">
          {isSignUp ? "Create an account" : "Sign in"}
        </h1>
        <p className="mt-2 mb-6 text-sm text-[var(--sea-ink-soft)]">
          {isSignUp ? "Enter your information to create an account" : "Enter your email below to sign in"}
        </p>
